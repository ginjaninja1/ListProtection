...
namespace ListProtection.Tasks
{
    ...
    /// </summary>
    public class ListProtectionTask : IScheduledTask
    {
        private readonly ILibraryManager libraryManager;
        private readonly IFileSystem fileSystem;
        private readonly ILogger logger;

        public ListProtectionTask(ILibraryManager libraryManager, IFileSystem fileSystem, ILogManager logManager)
        {
            this.libraryManager = libraryManager;
            this.fileSystem = fileSystem;
            this.logger = logManager.GetLogger("ListProtection");
        }

        public string Name => "Copy Posters to Folder Images";

        public string Key => "ListProtectionTask";
